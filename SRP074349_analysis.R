...
sra_metadata = read.csv("/Users/rusiq/Downloads/SRP074349_run.csv")
...
merged_data$class = ifelse(endsWith(merged_data$title, "N"), "NORMAL", "TUMPOR")
control_vec <- unique(merged_data[merged_data$class == "NORMAL", "geo_accession"])

#READ EXPRESSION
expr_df = read.csv("/Users/rusiq/Desktop/IGR/SRP074349_raw_counts.tsv", sep = "\t")
...
loh <- readBAFExtractOutput(path="/Users/rusiq/Desktop/IGR/SRP074349_snp/",
...
saveRDS(final.objects, "SRP074349_finals.rds")
...
write.csv(test_df, "SRP074349_deletions.csv")
