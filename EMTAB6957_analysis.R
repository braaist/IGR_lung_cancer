...
#ANALYZE METADATA
metadata = read.csv("/Users/rusiq/Downloads/E-MTAB-6957.tsv", sep = "\t")
View(metadata)

#GET CONTROL SAMPLE IDS
control_vec <- unique(metadata[metadata$Characteristics.sampling.site. == "normal tissue adjacent to neoplasm", "Comment.ENA_EXPERIMENT."])

expr_df = read.csv("/Users/rusiq/Desktop/IGR/EMTAB6957_raw_counts.tsv", sep = "\t")
...
#LOAD LOH
loh <- readBAFExtractOutput(path="/Users/rusiq/Desktop/IGR/EMTAB6957_snp/",
...
saveRDS(final.objects, "EMTAB6957_finals.rds")
...
write.csv(test_df, "EMTAB6957_deletions.csv")
