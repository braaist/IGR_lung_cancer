...
sra_metadata = read.csv("/Users/rusiq/Downloads/SRP045225_run.csv")
merged_data <- merge(metadata, sra_metadata, 
                     by.x = "row.names", by.y = "SampleName",
                     all = TRUE)

View(merged_data)
control_vec <- merged_data[merged_data$source_name_ch1 == "normal", "Run"]

expr_df = read.csv("/Users/rusiq/Desktop/IGR/SRP045225_quant.tsv", sep = "\t")
...
loh <- readBAFExtractOutput(path="/Users/rusiq/Desktop/IGR/SRP045225_snp/",
...
#saveRDS(final.objects, "SRP045225_finals.rds")

expr_df <- expr_df[,!colnames(expr_df) %in% c("SRR1797294", "SRR1797293", 
                                              "SRR1797271", "SRR1797270",
                                              "SRR1797269", "SRR1797268", 
                                              "SRR1797267")]
...
write.csv(test_df, "SRP045225_deletions.csv")
